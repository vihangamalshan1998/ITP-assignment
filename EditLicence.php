...
<html lang="en">
  <head>
  <!-- Title -->
    <title>Edit Licence Details</title>
      ...
      <div class="container space-2">
        ...
        <form class="media align-items-center mb-7">
          ...
          <div class="media-body">
            ...
            <label for="cutomer-name" class="lead text-right ml-11">Vehicle Number - SP GAA-128</label>
        ...
        <form method="post"  enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                    <label for ="Gname" class="lead">Insuarance Co Name </label>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-6">
                    <label for ="Gphone" class="lead">Insuarance Policy No</label>
                    <div class="input-group mb-3">
            ...
            <div class="row">
                <!-- Starting Mileage-->
                <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                    <label for ="Status" class="lead">Insuarance Exp Date</label>
                    <div class="input-group mb-3">
                        <input type="date" class="form-control"  name="status">     
                    </div> 
                </div>
                <div class="col-12 col-sm-12 col-md-4 col-lg-6">
                    <label for ="Tamount" class="lead">Licence Exp Date</label>
                    <div class="input-group mb-3">
                        <input type="date" class="form-control"  name="Tamount">
                    </div> 
                </div>
            </div>
          <!-- Buttons -->
          ...
          <div class="col-md-4">
            ...
            <a href="LView.php" class="btn btn-sm btn-primary transition-3d-hover btn-warning">Cancel</a>
