                    ...
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        ...
                        <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                <li class="breadcrumb-item"><a class="breadcrumb-link"
                                        ...
                                        <li class="breadcrumb-item"><a class="breadcrumb-link"
                                        href="black-list.php">Black Lists</a></li>
                                <li class="breadcrumb-item active" aria-current="page">User Black List</li>
                            </ol>
                            <!-- End Breadcrumb -->
                ...
                <div class="card">
                    ...
                    <div class="border rounded p-5">
                        ...
                        <div class="col-sm-6">
                          ...
                          <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                              ...
                              <span class="font-weight-medium">CB23465</span>
                            </li>
                            <li class="mb-2">
                      ...
                      <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <h5 class="text-dark font-size-1 text-uppercase">Blacklisted Vehicles:</h5>
                        ...
                        <li class="list-inline-item">
                          <a href="#">
                            ...
                            Print details
                                        ...
                                        <td class="align-middle text-primary">Vessal</td>
                                        <td class="align-middle text-secondary">Black</td>
                                        <td class="align-middle text-danger">2019</td>
