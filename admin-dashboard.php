            ...
            <div class="u-cubeportfolio space-bottom-2">
              ...
              {"width": 300, "cols": 1}
                    ...
                    <div class="cbp-item rounded graphic">
                        <a class="cbp-caption" href="pending-list.php">
                            <div class="cbp-caption-defaultWrap">
                                <img src="images/pending.png" alt="Image Description">
                            </div>
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">Pending List</h4>
                    ...
                    <!-- Item -->
                    <div class="cbp-item rounded graphic">
                        <a class="cbp-caption" href="release-request-list.php">
                            <div class="cbp-caption-defaultWrap">
                                <img src="images/release.png" alt="Image Description">
                            </div>
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">Release Request List</h4>
                    ...
                    <div class="cbp-item rounded branding">
                        <a class="cbp-caption" href="inquiry-list.php">
                            <div class="cbp-caption-defaultWrap">
                                <img src="images/inquiry.png" alt="Image Description">
                            </div>
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">Inquiry List</h4>
                    ...
                    <!-- Item -->
                    <div class="cbp-item rounded branding">
                        <a class="cbp-caption" href="black-list.php">
                            <div class="cbp-caption-defaultWrap">
                                <img src="images/black.png" alt="Image Description">
                            </div>
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">Black List</h4>
                    ...
                    <!-- Item -->
                    <div class="cbp-item rounded branding">
                        <a class="cbp-caption" href="all-users.php">
                            <div class="cbp-caption-defaultWrap">
                            ...
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">All Users</h4>
                    ...
                    <!-- Item -->
                    <div class="cbp-item rounded branding">
                        <a class="cbp-caption" href="all-vehicles.php">
                            <div class="cbp-caption-defaultWrap">
                                <img src="images/vehicles.png" alt="Image Description">
                            </div>
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">All Vehicles</h4>
                    ...
                    <!-- Item -->
                    <div class="cbp-item rounded branding">
                        <a class="cbp-caption" href="admin-reports.php">
                            <div class="cbp-caption-defaultWrap">
                                <img src="images/reports.png" alt="Image Description">
                            </div>
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">Reports</h4>
                    ...
                    <!-- Item -->
                    <div class="cbp-item rounded branding">
                        <a class="cbp-caption" href="upload-agreement.php">
                            <div class="cbp-caption-defaultWrap">
                                <img src="images/agree.png" alt="Image Description">
                            </div>
                            <div class="cbp-caption-activeWrap bg-primary">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                                        <h4 class="h6 text-white mb-0">Upload Agreement</h4>
                                            ...
                                            <div class="media align-items-center">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid rounded-circle"
                                                        src="../../assets/img/100x100/img8.jpg" alt="Image Description">
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <a class="card card-frame mb-2" href="javascript:;"
                                        ...
                                        <div class="card-body align-items-sm-center p-2">
                                            <div class="media align-items-center">
                                                <div class="u-avatar mr-3">
                                                    <img class="img-fluid rounded-circle"
                                                        src="../../assets/img/100x100/img10.jpg"
                                                        alt="Image Description">
                                                </div>
                                                <div class="media-body">
