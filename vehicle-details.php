                    ...
                    <div class="col-lg-7 order-lg-1">
                        ...
                        <div class="media d-block d-sm-flex align-items-sm-center">
                            ...
                            <div class="media-body">
                                <h1 class="h3 text-white font-weight-medium mb-1">Welcome,Name!</h1>
                                    ...
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        ...
                                        <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover"
                                            ...
                                            <ul id="accessibilityDropdownMenu"
                                                ...
                                                <li><a class="nav-link u-header__sub-menu-nav-link" href="">Details</a>
                                                </li>
                                                <li><a class="nav-link u-header__sub-menu-nav-link" href="">Available
                                                        Vehicles</a></li>
                                                <li><a class="nav-link u-header__sub-menu-nav-link" href="">Unavailable
                                                        Vehicles</a></li>
                                            </ul>
                                        </li>
                                        <!-- Vehicle Details  -->
                    ...
                    <div class="card-deck d-block d-md-flex">
                        ...
                        <div class="card mb-5">
                            <div class="u-lg-avatar  mb-11 ">
                                ...
                                <img src="images/add.png" alt="Image Description">
                            </div>
