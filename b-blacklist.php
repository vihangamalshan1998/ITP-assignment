    ...
    <main id="content" role="main">
        ...
        <div class="bg-light">
            <div class="container space-2">
                ...
                <!-- Personal Info Form -->
                <form class="js-validate" method="POST" action="register.php" enctype="multipart/form-data">
                <hr class="my-7">
                <h2><b>Add to the Black List</b></h2><br>
                    <div class="row">
                        <!-- Input -->
                            ...
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="fname" value=""
                                        placeholder="Enter your nic" aria-label="Enter your first name" required
                            ...
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="lname" value=""
                                        placeholder="Enter your name" aria-label="Enter your last name" required
            ...
            <div class="col-sm-6 mb-12">
                    ...
                    <!-- Buttons -->
                    <button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1" name="submit">Submit
