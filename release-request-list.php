...
<head>
    <!-- Title -->
    <title>Release Request List </title>
                ...
                <div class="row">
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        ...
                        <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Release Request List</li>
                            </ol>
                            <!-- End Breadcrumb -->
...
$sql = "SELECT  Vehicle_No,RequestId,RequestDate,RequiredDate,Status,Description  FROM release_request  WHERE Status = 'Pending' ";
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                          ...
                          <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                              ...
                              <span class="font-weight-medium"><?php echo $row["RequestDate"]; ?></span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Requried Date:</span>
                              <span class="font-weight-medium"><?php echo $row["RequiredDate"]; ?></span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Description:</span>
                              <span class="font-weight-medium"><?php echo $row["Description"]; ?></span>
                            </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-sm-6">
                          ...
                          <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                              ...
                              <span class="font-weight-medium"><?php echo $row["Vehicle_No"]; ?></span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Model:</span>
                              <span class="font-weight-medium">Honda</span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Brand:</span>
                              <span class="font-weight-medium">Vezzal</span>
                            </li>
                            <li class="mb-2">
                            ...
                            <li class="mb-2">
                              ...
                              <span class="font-weight-medium">2019</span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Exp Date:</span>
                              <span class="font-weight-medium">2022</span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Meter Readings:</span>
                              <span class="font-weight-medium">1456577</span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Damages:</span>
                              <span class="font-weight-medium">No Damages</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                          ...
                          <a href="#">
                            ...
                            Print details
                                        ...
                                        <td
                                            ...
                                            <?php echo $row["RequestId"]; ?></td>
                                        <td class="align-middle">
                                            <div class="media align-items-center">
                                                
                                                <span><?php echo $row["Vehicle_No"]; ?></span>
                                            </div>
                                        </td>
                                        <td class="align-middle text-primary"><?php echo $row["Status"]; ?></td>
                                        <td class="align-middle text-secondary"><?php echo $row["RequestDate"]; ?></td>
                                        <td class="align-middle text-danger"><?php echo $row["RequiredDate"]; ?></td>
                                        <td class="align-middle text-secondary"><?php echo $row["Status"]; ?></td>
                                        <td class="align-middle text-danger"><?php echo $row["Description"]; ?></td>
