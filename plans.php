...
<head>
  <!-- Title -->
  <title>Plans | Front - Responsive Website Template</title>
...
?>
  ...
  <main id="content" role="main">
    ...
    <!-- Content Section -->
    <div class="bg-light top1 ">
      <div class="container space-2">
        <div class="mb-9">
          <!-- Title -->
          <div class="mb-3">
            <h2 class="h5 mb-0">MY JOURNEY</h2>
          </div>
          <!-- End Title -->
          ...
          <div class="card-deck d-block d-md-flex">
            <div class="card mb-4 mb-md-0">
              ...
              <div class="card-body p-5">
                <h4 class="h6">Journey - 12.08.2020 </h4>
                <p class="font-size-1">Customer's Name <span class="text-dark font-weight-medium">Lakmal Bandara</span></p>
                <p class="font-size-1">Customer's Phone Number: <span class="text-dark font-weight-medium">0712345678</span></p>
                <p class="font-size-1">Date: <span class="text-dark font-weight-medium">20.08.2020</span></p>
                <p class="font-size-1">Pick-up place: <span class="text-dark font-weight-medium">Colombo</span></p>
                <p class="font-size-1">Drop off Place: <span class="text-dark font-weight-medium">Kandy</span></p>
                <p class="font-size-1">Pick-up time: <span class="text-dark font-weight-medium">10.00</span></p>
                <p class="font-size-1">Number of passengers: <span class="text-dark font-weight-medium">4</span></p>
                <p class="font-size-1">Vehicle Type: <span class="text-dark font-weight-medium">Toyota</span></p>
                <p class="font-size-1">Vehicle Name: <span class="text-dark font-weight-medium">Aqua</span></p>
                <p class="font-size-1">Vehicle Number: <span class="text-dark font-weight-medium">CD1234</span></p>
            ...
            <div class="card">
              ...
              <p><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.65589617791!2d79.84083831459286!3d6.93166819499177!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae259251b57a431%3A0x8f44e226d6d20a7e!2sHotel%20Galadari!5e0!3m2!1sen!2slk!4v1599327567143!5m2!1sen!2slk" width="450" height="400" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe></p>
        ...
        <div class="row justify-content-between align-items-center mb-3">
          ...
          <div class="col-sm-6 text-sm-right">
            <div class="btn-group btn-group-toggle">
              <a class="js-animation-link btn btn-sm btn-outline-primary btn-sm-wide active" href="replacement.php"
                 data-target="#pricingMonthly"
                 data-link-group="idPricing">
                Make A Replacement
              </a>
          ...
          <a class="js-animation-link btn btn-sm btn-outline-primary btn-sm-wide active" href="driver-dashboard.php"
                data-target="#pricingMonthly"
                data-link-group="idPricing">
               Back
             </a>
