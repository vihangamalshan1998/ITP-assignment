    ...
    <main id="content" role="main">
        ...
        <div class="bg-light top">
            <div class="container space-2">
                ...
                <!-- Personal Info Form -->
                <h2><b>Add Drivers</b></h2><br>
                <form class="js-validate" action="insert.php" method="POST" enctype="multipart/form-data">
                <hr class="my-7">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="date" class="form-control" name="dob" value="London, England" placeholder="Enter your location" aria-label="Enter your location" required aria-describedby="locationLabel"
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="lno" value="" placeholder="Enter your email address" aria-label="Enter your email address" required aria-describedby="emailLabel"
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                <label id="locationLabel" class="form-label">
                  Expiery Date of the License
                  <span class="text-danger">*</span>
                </label>

                <div class="form-group">
                  <input type="date" class="form-control" name="exdate" value="London, England" placeholder="Enter your location" aria-label="Enter your location" required aria-describedby="locationLabel"
                         data-msg="Please enter your location."
                         data-error-class="u-has-error"
                         data-success-class="u-has-success">
                </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                <label id="locationLabel" class="form-label">
                  Back side image of NIC
                  <span class="text-danger">*</span>
                </label>

                <div class="form-group">
                <input type="file" name="nic2"class="form-control" name="license_front" value="natalie.curtis@gmail.com" placeholder="Enter your email address" aria-label="Enter your email address" 
                         data-error-class="u-has-error"
                         data-success-class="u-has-success" >
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                <label id="emailLabel" class="form-label">
                  Front side image of License
                  <span class="text-danger">*</span>
                </label>

                <div class="form-group">
                  <input type="file" class="form-control" name="license_front" value="natalie.curtis@gmail.com" placeholder="Enter your email address" aria-label="Enter your email address" 
                         data-error-class="u-has-error"
                         data-success-class="u-has-success">
                </div>
              </div>
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                <label id="locationLabel" class="form-label">
                  Back side image of License
                  <span class="text-danger">*</span>
                </label>

                <div class="form-group">
                  <input type="file" class="form-control" name="license_back" value="London, England" placeholder="Enter your location" aria-label="Enter your location" 
                         data-msg="Please enter your location."
                         data-error-class="u-has-error"
                         data-success-class="u-has-success">
                </div>
          ...
          <div class="row">
                        ...
                        <div class="col-sm-6 mb-6">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <button class="dropdown-item" type="button">UnApproved</button>
                            </div>
                            </div>
                        </div>
                        <!-- End Input -->
