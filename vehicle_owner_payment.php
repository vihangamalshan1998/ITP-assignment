...
if(isset($_SESSION['mysess'])){
  ...
  if(isset($_POST['btnSearch'])){
    ...
    header('Location:vehicle_owner_payment1.php?vno='.$vno);
  }

  $sqlr = mysqli_query($con,"SELECT * FROM vehicle v,vehicle_owner o WHERE v.NIC=o.NIC");
            ...
            <div class="col-sm-6 mb-2">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <select class="form-control custom-select" name="vehicleNo" required
                    ...
                    ?>
                    <option value="<?php echo $record['vehicle_No'];?>"><?php echo $record['vehicle_No'];?></option>
                    <?php
                      }
                    ?>
                  </select>
