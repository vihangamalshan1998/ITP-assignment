                        ...
                        <div
                            ...
                            <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active"><a class="breadcrumb-link"
                                        href="8.vehicle-details.php">Vehicle Details</a></li>
                                </li>
                ...
                <div class="mb-7">
                    ...
                    <div class="card-deck d-block d-md-flex">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="u-lg-avatar  mb-11 ">
                                ...
                                <img src="images/addv.png" alt="Image Description">
                            </div>
                            ...
                            <!-- Button -->
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover" href="10.add-vehicles.php">

                                Requests For Adding A New Vehicle
                            </a>
                            <!-- End Button -->
                    ...
                    <div class="card-deck d-block d-md-flex">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="u-lg-avatar  mb-11 ">
                                ...
                                <img src="images/releasev.png" alt="Image Description">
                            </div>
                            <div class="card-body p-6">
                            ...
                            <!-- Button -->
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover" href="11.rerelease-vehicles.php">

                                Requests For Releasing Vehicle
                            </a>
                            <!-- End Button -->
                    ...
                    <div class="card-deck d-block d-md-flex">
                        ...
                        <div class="card mb-5">
                            ...
                            <!-- Button -->
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover" href="12.inquiry-vehicles.php">
