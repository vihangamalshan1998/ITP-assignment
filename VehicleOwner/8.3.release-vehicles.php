                    ...
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        <div
                            ...
                            <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Released Vehicles</li>
                            </ol>
                            <!-- End Breadcrumb -->
...
$sql = "SELECT  vehicle_No,Model,Brand,Manu_Year,Color,Meter_Readings FROM vehicle  WHERE Status = 'Released' ";
                        ...
                        <li class="list-inline-item">
                          <a href="#">
                            ...
                            Print details
                                        ...
                                        <td class="align-middle text-danger"><?php echo $row["Brand"]; ?></td>
...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"INSERT INTO inquery (vehicle_No,Description) VALUES ('$vno','$des')");
    if($sql){
       echo "Success!";
    }
    else{
                            ...
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="vno" value=""
                                        ...
                                        required aria-describedby="fnameLabel"
                            ...
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="des" value=""
                                        placeholder="Enter your  Description" aria-label="Enter your  Description"
                                        required aria-describedby="fnameLabel"
                                        data-msg="Please enter your  Description." data-error-class="u-has-error"
                                        data-success-class="u-has-success">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-6">
                            <div class="js-form-message">
                                ...
                                <label
                                    class="btn btn-sm btn-primary transition-3d-hover file-attachment-btn mb-1 mb-sm-0 mr-1"
