                    ...
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        <div
                            ...
                            <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="4.profile.php?uid=<?php echo $record['user_id'];?>">Profile</a>
                                </li>
                ...
                <div class="mb-7">
                    ...
                    <div class="card-deck d-block d-md-flex">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="u-lg-avatar  mb-11 ">
                                ...
                                <img src="images/pay1.png" alt="Image Description">
                            </div>
                            ...
                            <!-- Button -->
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover" href="">
                    ...
                    <div class="card-deck d-block d-md-flex">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="u-lg-avatar  mb-11">
                                <img src="images/current1.png" alt="Image Description">
                            </div>
                            ...
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover"
                                ...
                                <span></span>
                                Current Vehicle Details Report
                            </a>
                            <!-- End Button -->
                    ...
                    <div class="card-deck d-block d-md-flex">
                        ...
                        <div class="card mb-5">
                            ...
                            <div class="u-lg-avatar  mb-11">
                                <img src="images/available1.png" alt="Image Description">
                            </div>
