...
<head>
    <!-- Title -->
    <title>Vehicle Owner Registation</title>
        ...
        <div class="bg-light">
            <div class="container space-2">
                ...
                <form class="js-validate" method="POST" action="reg.php" enctype="multipart/form-data">
                    <hr class="my-7">
                    <h2><b>Vehicle Owner Registration</b></h2><br>
                    <div class="row">
                        <!-- Input -->
                            ...
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input class="form-control" type="tel" name="address" value=""
                                        placeholder="Enter your address" aria-label="Enter your phone address" required
                                        aria-describedby="addressLabel" data-msg="Please enter a valid address"
                                        data-error-class="u-has-error" data-success-class="u-has-success">
                                </div>
                            </div>
                        </div>
