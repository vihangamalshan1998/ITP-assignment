...
<head>
    <!-- Title -->
    <title>Delete Release Request </title>
    ...
    <main id="content" role="main">
                    ...
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        <div
                            ...
                            <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Delete Release Requests</li>
                            </ol>
                            <!-- End Breadcrumb -->
        ...
        <div class="bg-light">
            <div class="container space-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-6">
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="fname" value="" placeholder=""
                ...
                <!-- Buttons -->
                <div class="d-flex ">
                    <button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1">Delete</button>
