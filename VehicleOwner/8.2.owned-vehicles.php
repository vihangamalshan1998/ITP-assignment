                    ...
                    <div class="col-lg-7 order-lg-1">
                        ...
                        <div class="media d-block d-sm-flex align-items-sm-center">
                            ...
                            <div class="media-body">
                                ...
                                <span class="d-block text-white"><?php echo $record["Email"]; ?></span>
                            </div>
                        </div>
                        <!-- End User Info -->
                    </div>
...
$sql = "SELECT  vehicle_No,Model,Brand,Manu_Year,Color,Meter_Readings FROM vehicle  WHERE Status = 'Approved' ";
...
while($row = $results->fetch_array())
{
    ...
    ?>
                    ...
                    <div class="border rounded p-5">
                      <h4 class="h3">Vehicle Details</h4>
                        ...
                        <div class="col-sm-6">
                          ...
                          <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                              ...
                              <span class="font-weight-medium"><?php echo $row["Model"]; ?></span>
                            </li>
                            <li class="mb-2">
                        ...
                        <li class="list-inline-item">
                          <a href="#">
                            ...
                            Print details
                                        ...
                                        <td class="align-middle text-secondary"><?php echo $row["Color"]; ?></td>
                                        <td class="align-middle text-danger"><?php echo $row["Manu_Year"]; ?></td>
                                        <td class="align-middle text-danger">
                                            <!-- Button -->
                                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover"
                                                href="#addProjectModal" data-modal-target="#addProjectModal">
                                                <span class="fas fa-plus small mr-2"></span>
                                                Request To Release Vehicle
                                            </a>
                                            <!-- End Button -->
                                        </td>
                                    </tr>
...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($con,"INSERT INTO release_request (vehicle_No,Description,Status) VALUES ('$vno','$reason','Pending')");
    if($sql){
       //echo "Success!";
    }
    else{
        ...
        <form class="card mb-9" action = "#" method = "POST">
            ...
            <div class="card-body pt-3 pb-5 px-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-6">
                            <div class="js-form-message">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="reason" value="" placeholder=""
                                        aria-label="" required aria-describedby="fnameLabel" data-msg=""
                                        data-error-class="u-has-error" data-success-class="u-has-success">
                ...
                <div class="d-flex justify-content-end">
                    <input type="submit" name = "submit" value = "Request" class="btn btn-sm btn-primary transition-3d-hover mr-1">
                    <button type="submit" class="btn btn-sm btn-soft-secondary transition-3d-hover"
                        onclick="Custombox.modal.close();">Cancel</button>
                </div>
                <!-- End Buttons -->
                </form>
                <!-- End Release Request Info Form -->
            </div>
        </form>
    </div>
    <!-- End Release Request  Modal Window -->
