                    ...
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        <div
                            ...
                            <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Inquries</li>
                            </ol>
                            <!-- End Breadcrumb -->
                    ...
                    <div class="col-lg-7 order-lg-1">
                        ...
                        <div class="media d-block d-sm-flex align-items-sm-center">
                            ...
                            <div class="media-body">
                                <h1 class="h3 text-white font-weight-medium mb-1"><?php echo $name=$record['Fname'];?></h1>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="js-focus-state input-group input-group-sm">
                                        ...
                                        <input id="datatableSearch" type="email" class="form-control"
                                            placeholder="Search Inqueries" aria-label="Search activities"
...
while($row = $results->fetch_array())
{
    ...
    ?>
                    ...
                    <div class="border rounded p-5">
                      <h4 class="h3">Inqueiry Details</h4>
