...
while($row = $results->fetch_array())
{
    ...
    ?>
                    ...
                    <div class="border rounded p-5">
                      <h4 class="h3">Inquiry Details</h4>


                      <div class="row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                          <h5 class="text-dark font-size-1 text-uppercase">Inueiry Info:</h5>
                          <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                              <span class="text-secondary">Vehicle Number:</span>
                              <span class="font-weight-medium"><?php echo $row["InquiryId"]; ?></span>
                            </li>
                            <li class="mb-2">
                        ...
                        <li class="list-inline-item">
                          <a href="#">
                            ...
                            Print details
                                        ...
                                        <td class="align-middle text-secondary"><?php echo $row["Description"]; ?></td>
