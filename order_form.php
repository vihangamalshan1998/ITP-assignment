...
<?php include ('header.php');?>
  ...
  <main id="content" role="main">
    ...
    <div class="bg-light">
      ...
      <h2>PRODUCT ORDER FORM</h2><hr><br>
        ...
        <form class="js-validate">
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="itcode" placeholder="Enter item code" aria-label="Enter your name" required aria-describedby="nameLabel"
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="Sid" placeholder="Enter supplier's ID" aria-label="Enter your name" required aria-describedby="nameLabel"
          ...
          <div class="row">
            <!-- Input -->
             <div class="col-md-3 mb-3 mb-sm-6">
              <div class="js-form-message">
                <label id="nameLabel" class="form-label">
                  Color
                </label>
                <div class="form-group">
                  <input type="color" id="favcolor" name="favcolor" value="#0000"  class="form-control" >
                </div>
              </div>
            </div>
            <!-- End Input -->
            ...
            <div class="col-md-3 mb-3 mb-sm-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="size" placeholder="Input size" aria-label="Enter your name" required aria-describedby="nameLabel"
            ...
            <div class="col-md-3 mb-3 mb-sm-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="qty" placeholder="Input quantity" aria-label="Enter your name" required aria-describedby="nameLabel"
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="date" class="form-control" name="odate" value="London, England" placeholder="Enter your location" aria-label="Enter your location" required aria-describedby="locationLabel"
          ...
          <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="date" class="form-control" name="rdate" value="London, England" placeholder="Enter your location" aria-label="Enter your location" required aria-describedby="locationLabel"
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="email" class="form-control" name="email" placeholder="Enter supplier's email address" aria-label="Enter your email address" required aria-describedby="emailLabel"
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="organization" placeholder="...." aria-label="Enter your organization name" required aria-describedby="organizationLabel"
          ...
          <!-- Buttons -->
          <button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1">Order</button>
