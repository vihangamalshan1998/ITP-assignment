                        ...
                        <div
                            ...
                            <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                <li class="breadcrumb-item"><a class="breadcrumb-link"
                                        href="#">Home</a></li>
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="3.profile.php">Account</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Replacement Requets</li>
                            </ol>
                            <!-- End Breadcrumb -->
      ...
      <div class="container space-bottom-1 space-bottom-lg-0">
                <div class="d-lg-flex justify-content-lg-between align-items-lg-center">
                                    ...
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        ...
                                        <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover"
                                            ...
                                            <ul id="generalDropdownMenu"
                                                ...
                                                <li><a class="nav-link u-header__sub-menu-nav-link"
                                                        href="3.profile.php">Profile</a></li>
                                        ...
                                        <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover"
                                            ...
                                            <ul id="accountSettingsDropdownMenu"
                                                ...
                                                <li><a class="nav-link u-header__sub-menu-nav-link"
                                                        href="2.edit-profile.php">Edit profile</a></li>
                                                <li><a class="nav-link u-header__sub-menu-nav-link"
                                        ...
                                        <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover"
                                            ...
                                            <ul id="billingDropdownMenu"
                                                ...
                                                <li><a class="nav-link u-header__sub-menu-nav-link"
                                                        href="4.PaymentHistory.php">Payment history</a></li>
                                            </ul>
                                        </li>
                                        <!-- Payements -->
                                        ...
                                        <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover"
                                            ...
                                            <ul id="accessibilityDropdownMenu"
                                                ...
                                                <li><a class="nav-link u-header__sub-menu-nav-link"
                                                        href="8.JourneyHistory.php">Journey Report</a></li>
                                        ...
                                        <ul id="accessibilityDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="accessibilityDropdown">
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="7.Replacement.php">Request Replacement</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link" href="3.FeedBack.php">FeedBack</a></li>
                    ...
                    <div class="ml-lg-auto">
                        <!-- Button -->
                        <a class="btn btn-sm btn-soft-white text-nowrap transition-3d-hover" href="3.profile.php">View My
                            Profile</a>
                        <!-- End Button -->
                    </div>
                </div>
      ...
      <div class="container space-2">
        <div class="row">
          ...
          <div class="col-lg-9">
            <!-- User Details -->
            <div class="mb-4">
              <h2 class="h4">User Name <span class="badge badge-success ml-1">Customer</span></h2>
            ...
            <hr class="my-7">
            <h2><b>Vehicle Replacement</b></h2><br>
            <div class="row">
                    ...
                    <div class="js-form-message">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="nic" value=""
                                placeholder="Enter your nic number" aria-label="Enter your nic number"
                                required aria-describedby="phoneNumberLabel"
                                data-msg="Please enter a valid nic number." data-error-class="u-has-error"
                    ...
                    <div class="js-form-message">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="name" value=""
                                ...
                                data-msg="Please enter tour name" data-error-class="u-has-error"
                                data-success-class="u-has-success">
            ...
            <div class="row">
                <div class="col-sm-6 mb-6">
                    <div class="js-form-message">
                        <label id="vehicleNumberLabel" class="form-label">
                        Vehicle Number
                            <span class="text-danger">*</span>
                        </label>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="vehicleno" value=""
                                ...
                                required aria-describedby="phoneNumberLabel"
                                data-msg="Please enter a valid vehicle number." data-error-class="u-has-error"
                                data-success-class="u-has-success">
                    ...
                    <div class="js-form-message">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="location" value=""
                                placeholder="Enter your current location" aria-label="Enter your location"
                                required aria-describedby="locationLabel"
                                data-msg="Please enter your current location." data-error-class="u-has-error"
                                data-success-class="u-has-success">
