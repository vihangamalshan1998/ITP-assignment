...
<body>
    ...
    if(isset($_POST['Insert'])){
        ...
        $sql1 = mysqli_query($conn,"INSERT INTO Support_service (Vehicle_No,Total_Amount, Description, Scanned_copy_of_Bill)
        VALUES ('$Vehicle_No','$Total_Amount','$Description','0')");

        $gid = mysqli_insert_id($conn);

    if ($sql1){
        
        $sql1 = mysqli_query($conn,"INSERT INTO Garage (G_ID,Garage_Name,Repaired_Date,Garage_phone_no,Garage_Address)
    ...
    $sql2=mysqli_query($conn,"SELECT S_ID FROM Support_service");
