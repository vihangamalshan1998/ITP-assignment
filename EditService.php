      ...
      <div class="container space-2">
        ...
        <form class="media align-items-center mb-7">
          ...
          <div class="media-body">
            <label for="cutomer-name" class="lead">Service ID - 1</label>
            <label for="cutomer-name" class="lead text-right ml-11">Vehicle Number - SP GAA-1028</label>
            <label for="cutomer-name" class="lead text-right ml-11">Serviced Date - 2019-12-05</label>
        ...
        <form method="post"  enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                    <label for ="Gname" class="lead">Serice Name </label>
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-6">
                    <label for ="Gphone" class="lead">Service Phone No</label>
                    <div class="input-group mb-3">
            ...
            <div class="row">
                <!-- Starting Mileage-->
                <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                    <label for ="Status" class="lead">Service Address</label>
                    <div class="input-group mb-3">
            ...
            <div class="row">
            <div class="col-12 col-sm-12 col-md-4 col-lg-6">
                    <label for ="Tamount" class="lead">Next Service</label>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control"  name="Tamount">
                    </div> 
                </div>
          ...
          <div class="col-md-4">
            <input type="button" name="button"  class="btn btn-sm btn-primary transition-3d-hover" value="Update" data-toggle="modal" data-target="#ModalScrollBody">
            <a href="SView.php" class="btn btn-sm btn-primary transition-3d-hover btn-warning">Cancel</a>
