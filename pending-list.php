                ...
                <div class="row">
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        ...
                        <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Pending Lists</li>
                            </ol>
                            <!-- End Breadcrumb -->
                    ...
                    <div class="card-deck d-block d-md-flex">
                          ...
                          <div class="card mb-5">
                            <div class="u-lg-avatar  mb-11 ">
                                ...
                                <img src="../images/ublack.png" alt="Image Description">
                            </div>
                            ...
                            <!-- Button -->
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover" href="user-pending-list.php"
                                >
                                User Pending List
                            </a>
                            <!-- End Button -->
                    ...
                    <div class="card-deck d-block d-md-flex">
                          ...
                          <div class="card mb-5">
                            <div class="u-lg-avatar  mb-11 ">
                                ...
                                <img src="../images/vpend.png" alt="Image Description">
                            </div>
                            <div class="card-body p-6">
                            ...
                            <!-- Button -->
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover" href="vehicle-pending-list.php"
                                >
                                Vhicle Pending List
                            </a>
                            <!-- End Button -->
