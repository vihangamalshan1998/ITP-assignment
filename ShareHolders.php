   ...
   <!-- ========== MAIN ========== -->
    ...
    <div class="bg-light">
      <div class="container space-2">
        ...
        <h2><p class="lead text-primary " style="font-size:48px;">Add ShareHolders</p></h2>
        <form method="post" action="insertTrip.php"  enctype="multipart/form-data">
            ...
            <div class="row">
                <!-- Starting Mileage-->
                <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                    <label for ="Status" class="lead">Agreement </label>
                    <div class="input-group mb-3">
                    <input type="submit" name="submit" class="btn btn-sm btn-secondary transition-3d-hover btn-lg btn-block" value="Download Agreements">     
                    </div> 
                </div>
                <div class="col-12 col-sm-12 col-md-4 col-lg-6">
