            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="Enter item code" aria-label="Enter tem code" required aria-describedby="nameLabel"
