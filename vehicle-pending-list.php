...
<head>
    <!-- Title -->
    <title>Vehicle Pending List </title>
                ...
                <div class="row">
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        ...
                        <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Vehicle Pending List</li>
                            </ol>
                            <!-- End Breadcrumb -->
...
$sql = "SELECT  vehicle_No,Model,Brand,Manu_Year,Color,Meter_Readings,Status FROM vehicle  WHERE Status = 'Pending' ";
                        ...
                        <div class="col-sm-6">
                          ...
                          <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                              ...
                              <span class="font-weight-medium"><?php echo $row["Color"]; ?></span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Year:</span>
                              <span class="font-weight-medium"><?php echo $row["Manu_Year"]; ?></span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Exp Date:</span>
                              <span class="font-weight-medium"><?php echo $row["Status"]; ?></span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Meter Readings:</span>
                              <span class="font-weight-medium"><?php echo $row["Meter_Readings"]; ?></span>
                            </li>
                            <li class="mb-2">
                        ...
                        <li class="list-inline-item">
                          <a href="#">
                            ...
                            Print details
                                        ...
                                        <td class="align-middle text-danger"><?php echo $row["Status"]; ?></td>
