...
<html lang="en">
  <head>
  <!-- Title -->
    <title>Administration | Trip Editor</title>
   ...
   <!-- ========== MAIN ========== -->
    ...
    session_start();
     ...
     include'header.php';
      ...
      $sql="SELECT *  from trip t , reservation r , user u  WHERE t.TId = '$id' AND t.ResId = r.ResId AND r.NIC = u.NIC ";
      ...
      <div class="container space-2">
        ...
        <form class="media align-items-center mb-7">
          ...
          <div class="media-body">
            <p class="text-primary" style="font-size:30px;">Trip Editor</p>
            <label for="cutomer-name" class="lead"> customer name : <?php echo $row['Fname'];?> </label>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" class="form-control"  name="s_mileage" value="<?php echo $row['s_mileage']; ?>">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control" name="deposit" value="<?php echo $row['Deposit']; ?>">
                    </div> 
                </div>
            </div>
            <div class="row">
                <!-- Starting Mileage-->
                <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                <label for ="inputEndingMileage" class="lead">Ending Mileage : </label>
                    <div class="input-group mb-3">
                        <input type="number" class="form-control"  name="e_mileage" value="<?php echo $row['e_mileage']; ?>">
                        <div class="input-group-prepend">
                            <span class="input-group-text">km</span>
                        </div>         
                    </div>  
...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql=mysqli_query($con,"UPDATE trip SET s_mileage='$_POST[s_mileage]' , Deposit = '$_POST[deposit]', e_mileage='$_POST[e_mileage]', Status='$_POST[status]',Description = '$_POST[description]' WHERE TId = '$_POST[id]'");
    if($sql){
