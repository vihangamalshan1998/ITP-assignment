      ...
      <div class="container space-0">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="Enter item code" aria-label="Enter your name" required aria-describedby="nameLabel"
          ...
          <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="Enter item name" aria-label="Enter your name" required aria-describedby="nameLabel"
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="Enter price of the item" aria-label="Enter your name" required aria-describedby="nameLabel"
        ...
        <div class="row">
            ...
            <div class="col-sm-6 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="Enter quantity of the item" aria-label="Enter your name" required aria-describedby="nameLabel"
           ...
           <div class="col-sm-6 mb-6">
            <div class="js-form-message">
              ...
              <div class="form-group">
                <input type="date" class="form-control" name="odate" placeholder="pick item recieved date" required aria-describedby="locationLabel"
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-6">
              <div class="js-form-message">
                ...
                <div class="form-group">
                  <input type="text" class="form-control" name="name" placeholder="Enter a description about the item" aria-label="Enter your name" required aria-describedby="nameLabel"
        ...
        <div class="mb-6">
            ...
            <div class="u-summernote-editor">
              <div class="js-summernote-editor" data-height="150"></div>
            </div>
