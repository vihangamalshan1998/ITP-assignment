              ...
              <table class="js-datatable table table-borderless u-datatable__striped u-datatable__content u-datatable__trigger mb-5"
                ...
                <tbody class="font-size-1">
                  <tr class="js-datatabale-details" data-details='
                    <div class="border rounded p-5">
                      ...
                      <div class="row mb-6">
                        ...
                        <div class="col-3">
                          ...
                          <span class="font-weight-medium">Kumara Rent A Car</span>
                        </div>
                        ...
                        <div class="col-sm-6">
                          ...
                          <ul class="list-unstyled mb-0">
                            <li class="mb-2">
                              ...
                              <span class="font-weight-medium">Rathnasiri</span>
                            </li>
                            <li class="mb-2">
                              <span class="text-secondary">Last name:</span>
                              <span class="font-weight-medium">Kumara</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                        ...
                        <div class="col-sm-6">
                          ...
                          <ul class="list-unstyled mb-0">
                            <li class="d-flex justify-content-between align-items-center mb-2">
                              <span class="text-secondary">Fixed amount</span>
                              <span class="font-weight-medium">LKR 50,000.00</span>
                            </li>
                            <li class="d-flex justify-content-between align-items-center mb-2">
                              <span class="text-secondary">Additional charges for Extra Mileages</span>
                              <span class="font-weight-medium">LKR 500.00</span>
                            </li>
                            <li class="d-flex justify-content-between align-items-center mb-2">
                              <span class="text-secondary">Total amount</span>
                              <span class="text-primary font-weight-medium">LKR 50,500.00</span>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <td class="align-middle text-secondary font-weight-normal u-datatable__trigger-icon">PID001</td>
                    <td class="align-middle">
                      <div class="media align-items-center">
                            <span>CBX-5623</span>
                      </div>
                    </td>
                    <td class="align-middle text-primary">LKR 50,500.00</td>
