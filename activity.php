      ...
      <div class="container space-2">
        <div class="row">
            <div class="col-12">
                ...
                <h1 class="lead"><p style="color:#377dff;font-size:50px;text-align:center;font-weight: 900;"> Journey History </p></h1>
            </div>
        </div>
        <div class="card">
                ...
                <tbody class="font-size-1">
                    <?php 
			            ...
			            if ($results -> num_rows >0)
			            {
                            ...
                            <tr>
                                <td class="align-middle text-primary"><?php echo $row['TId'];?></td>
                                <?php $id = $row['TId'];?>
                                <td class="align-middle text-primary"><?php echo $row['ResId'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Deposit'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Status'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Description'];?></td>
                                <td><p><a href='editTrip.php?Id=$id'>more details>></a></p></td>
                            </tr>
                        <?php                                    
                        }} else {
                            echo "0 results";
