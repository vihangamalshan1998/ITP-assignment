      ...
      <div class="container space-0">
        <div class="row">
            <div class="col-12">
                ...
                <h2>RESPONSIVE SUPPLIER TABLE</h2><hr>
            </div>
        </div>
        <div class="card">
                ...
                <?php 
			            ...
			            if ($results -> num_rows >0)
			            {
                            ...
                            <tr>
                                ...
                                <?php $id = $row['S_id'];?>
                                <td class="align-middle text-primary"><?php echo $row['S_name'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Address'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Joined_Date'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Mobile_Number'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Email'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Acc_No'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Acc_Name'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['Branch'];?></td>
                                <td class="align-middle text-primary"><?php echo $row['S_status'];?></td>
