          ...
          <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
            <div class="d-flex d-lg-inline-block justify-content-between justify-content-lg-end align-items-center align-items-lg-start">
              ...
              <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="admin-dashboard.php">Dashboard</a>
                                </li>
      ...
      <div class="container space-bottom-1 space-bottom-lg-0">
        <div class="d-lg-flex justify-content-lg-between align-items-lg-center">
                  ...
                  <ul class="navbar-nav u-header__navbar-nav">
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="generalDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="generalDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">View Customers</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Replacement</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Agreements</a></li>
                      </ul>
                    </li>
                    <!-- General -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="accountSettingsDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="accountSettingsDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">View Drivers</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Replacement</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Requested Drivers</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Agreements</a></li>
                      </ul>
                    </li>
                    <!-- Account Settings -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="billingDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="billingDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Add Vehicle Owner</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Add Vehicle</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Agreements</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">View</a></li>
                      </ul>
                    </li>
                    <!-- Billing -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="accessibilityDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="accessibilityDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Items</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Orders</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Supplier</a></li>
                      </ul>
                    </li>
                    <!-- Accessibility -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="accessibilityDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="accessibilityDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Service Details</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Garage Details</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Licence & Insurance</a></li>
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">Fuel</a></li>
                      </ul>
                    </li>
                    <!-- Accessibility -->
                    ...
                    <li class="nav-item hs-has-sub-menu u-header__nav-item"
                      ...
                      <ul id="accessibilityDropdownMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu--spacer" style="min-width: 230px;" aria-labelledby="accessibilityDropdown">
                        <li><a class="nav-link u-header__sub-menu-nav-link" href="#">View Reservation</a></li>
                      </ul>
                    </li>
                    <!-- Accessibility -->
          ...
          <div class="ml-lg-auto">
            <!-- Button -->
            <a class="btn btn-sm btn-soft-white text-nowrap transition-3d-hover" style="background-color:red;" href="../index.php?logout=true">Logout</a>
            <!-- End Button -->
          </div>
        </div>
      </div>
                        ...
                        <img  alt="Image Description" src ="">
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <!-- Title -->
                                    <div class="mb-4">
                                        <h3 class="h5 mb-1"> All User Details Report </h3>
                                        <p class="font-size-1">We strive to embrace and drive change in our industry.
                                        </p>
                                    </div>
                                    <!-- End Title -->
                        ...
                        <div class="card mb-5">
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <!-- Title -->
                                    <div class="mb-4">
                                        <h3 class="h5 mb-1">All Vehicle Details Report</h3>
                                        <p class="font-size-1">We strive to embrace and drive change in our industry.
                                        </p>
                                    </div>
                                    <!-- End Title -->
                            ...
                            <!-- Button -->
                            <a class="btn btn-sm btn-primary text-nowrap transition-3d-hover" href="8.2.owned-vehicles.php">
                                <span></span>
                                All Vehicle Details Report
                            </a>
                            <!-- End Button -->
                        ...
                        <div class="card mb-5">
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <!-- Title -->
                                    <div class="mb-4">
                                        <h3 class="h5 mb-1"> Vehicle Availability Report</h3>
...
?>
    ...
    <div id="addProjectModal" class="js-modal-window u-modal-window js-scrollbar" style="width: 800px;">
        <form class="card mb-9 ">
            ...
            <div class="card-body pt-3 pb-5 px-5">
                ...
                <div class="d-flex justify-content-end">
                    <button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1">Add</button>
