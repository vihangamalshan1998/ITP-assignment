          ...
          <div class="card-body p-4">
            ...
            <div class="table-responsive-md u-datatable">
              <table class="js-datatable table table-borderless u-datatable__striped u-datatable__content u-datatable__trigger mb-5"
                ...
                <?php 
                        include '../../config.php';
                        $sql = mysqli_query($con,"SELECT NIC,UserName,Email FROM user ");
                        if($sql){
                  ...
                  <tr class="js-datatabale-details" data-details='
                    ...
                    <td class="align-middle">
                      <div class="media align-items-center">
                            <span><?php echo $record['NIC']; ?></span>
                      </div>
                    </td>
                    <td class="align-middle text-primary"><?php echo $record['UserName']; ?></td>
                    <td class="align-middle text-secondary"><?php echo $record['Email']; ?>/td>
                    
                    <td><a href ="CusView.php" button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1" name="view" action="">View More
                    
                    </button></a></td>
                    <td><a href ="editCus.php" button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1" name="edit" action="#">Edit Details
                    
                    </button></a></td>
            <td><button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1" name="delete">Delete</button></td>
...
?>
  ...
  <!-- End Account Sidebar Navigation -->
              ...
              <br><br><br>
              <a href ="editCus.php" button type="submit" class="btn btn-sm btn-primary transition-3d-hover mr-1" name="add" action="b-blacklist.php">Add New Customers
