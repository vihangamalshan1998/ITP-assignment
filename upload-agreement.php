       ...
       <div class="bg-dark">
                ...
                <div class="row">
                    <div class="col-lg-5 order-lg-2 text-lg-right mb-4 mb-lg-0">
                        ...
                        <ol class="breadcrumb breadcrumb-white breadcrumb-no-gutter mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Upload Agreement</li>
                            </ol>
                            <!-- End Breadcrumb -->
        ...
        <div class="bg-light">
            <div class="container space-2">
                ...
                <div class="col-sm-8 col-md-5 ml-11">
                    <div class="card-deck d-block d-md-flex">

                        <!-- Tab -->
                        <div class="card mb-5">
                            <div class="u-lg-avatar  mb-3">
                ...
                <center>
                    <!-- Button -->
                    <a href="pdf/owner.pdf" target="_thapa"
                        class="btn btn-sm btn-primary text-nowrap transition-3d-hover ">
                    ...
                    <a href="pdf/owner.pdf" target="_thapa"
                        class="btn btn-sm btn-primary text-nowrap transition-3d-hover"> Print</a>
